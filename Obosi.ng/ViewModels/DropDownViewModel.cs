...
namespace Obosi.ng.Presentation.ViewModels
{
    public class DropDownViewModel
    {
        ...
        { 
            ...
            this.Units = await unit.GetAllUnitsByUnitType((int)UnitTypes.Village);
        }
        ...
        {   if (villageId == 0) 
            ...
            this.Units = await unit.GetAllUnitsByUnitType((int)UnitTypes.Aka);
            this.Villages = await village.GetVillages();
        }
        ...
        public async Task GetUmunnas(int akaId)
        {
            ...
            this.Units = await unit.GetAllUnitsByUnitType((int)UnitTypes.Umunna);
            this.Akas = await aka.GetAka();
        }
        public async Task GetImennes(int umunnaId)
        {
            ...
            this.Units = await unit.GetAllUnitsByUnitType((int)UnitTypes.Ime_Nne);
            this.Umunnas = await umunna.GetUmunna();
        }
