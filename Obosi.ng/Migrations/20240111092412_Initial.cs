        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_NewsArticle_NewsCategory_CategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsIndigene = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_NewsComment_NewsArticle_NewsArticleId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PostWallComment", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PostWallComment_Post_PostId",
                        column: x => x.PostId,
                        principalTable: "Post",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PostWallComment_User_UserId",
                        column: x => x.UserId,
                        principalTable: "User",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NewsComment_NewsArticleId",
                table: "NewsComment",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PostWallComment_PostId",
                table: "PostWallComment",
                column: "PostId");

            migrationBuilder.CreateIndex(
                name: "IX_PostWallComment_UserId",
                table: "PostWallComment",
                column: "UserId");
